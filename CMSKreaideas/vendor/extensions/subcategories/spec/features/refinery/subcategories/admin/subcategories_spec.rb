      ...
      describe "subcategories" do
        ...
        describe "create" do
          ...
          context "duplicate" do
            before { FactoryGirl.create(:subcategory, :name => "UniqueTitle") }
        ...
        describe "edit" do
          before { FactoryGirl.create(:subcategory, :name => "A name") }
        ...
        describe "destroy" do
          before { FactoryGirl.create(:subcategory, :name => "UniqueTitleOne") }
